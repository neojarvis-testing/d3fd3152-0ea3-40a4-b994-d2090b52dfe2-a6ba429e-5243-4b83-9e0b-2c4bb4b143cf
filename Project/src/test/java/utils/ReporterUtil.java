...
public class ReporterUtil {
    ...
    /**
     * Description: Generates an ExtentReports instance with a specified report
     * name.
     * 
     * @param String
    ...
    /**
     * Description: Attaches a screenshot to the ExtentTest report with a
     * description.
     * 
    ...
    public static void attachToReport(String filename, ExtentTest test, String description, WebDriver driver) {
        try {
            test.log(Status.INFO, description,
                    MediaEntityBuilder.createScreenCaptureFromPath(ScreenShot(filename, driver)).build());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
